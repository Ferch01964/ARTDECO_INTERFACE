      SUBROUTINE CONT_H2O(WV,ROH2O,DPRES,PR,TP,DZ,TAUH2O)
...
c ALT   : km
     ...
     9    1.00000,1.00000,1.00000/
      ...
      WTOT=XLOSMT*273.15/TP*PR/PREF*DZ*1.0E+05
...
C        THIS CHECK PREVENTS N FROM EXCEEDING NMAX IN THE ALGORITHM BELO
      ...
      SUBROUTINE CONT_N2(V,PR,TP,RON2,DZ,ROH2O,C4L)
...
C
C
      SUBROUTINE CONT_O2(V,PR,TP,ROO2,DZ,ROH2O,TAUO2)
